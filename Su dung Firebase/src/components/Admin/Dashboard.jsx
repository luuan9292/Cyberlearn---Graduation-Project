                ...
                datasets: [
                    {
                        ...
                        borderWidth: 1,
                        borderColor: ["rgba(255, 99, 132, 1)", "rgba(54, 162, 235, 1)", "rgba(255, 206, 86, 1)", "rgba(75, 192, 193, 1)", "rgba(153, 102, 255, 1)", "rgba(255, 159, 64, 1)"]
                    }
                ]
            },
            pieData: {
                        ...
                        <div className="views__detail">
                            ...
                            <div className="views__percent">
                                <span className="badge badge-success">
                                    30% <i className="fas fa-level-up-alt"></i>
                                </span>
                                <h4>5000</h4>
                            </div>
                        ...
                        <div className="views__detail">
                            ...
                            <div className="views__percent">
                                <span className="badge badge-danger">
                                    15% <i className="fas fa-level-down-alt"></i>
                                </span>
                                <h4>10000</h4>
                            </div>
                            <div className="progress">
                        ...
                        <div className="views__detail">
                            ...
                            <div className="views__percent">
                                <span className="badge badge-info">
                                    50% <i className="fas fa-level-up-alt"></i>
                                </span>
                                <h4>20000</h4>
                            </div>
                            <div className="progress">
                        ...
                        <div className="views__detail">
                            ...
                            <div className="views__percent">
                                <span className="badge badge-warning">
                                    80% <i className="fas fa-level-up-alt"></i>
                                </span>
                                <h4>50000</h4>
                            </div>
                            <div className="progress">
