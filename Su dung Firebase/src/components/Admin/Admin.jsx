...
import { setCurrentUser, signoutRequest } from "../../store/actions/users";
...
class Admin extends Component {
    ...
    showMenu = () => {
        let { dashboard, courses, users, messages } = this.state;
                            ...
                            <div className=" col-sm-2 col-md-2 col-lg-2 col-xl-2 px-0">
                                <div className="admin__manager">
                                    ...
                                    <ul className="px-0">
                                        ...
                                        <li onClick={() => this.handleChangeMenu("messages")} className={this.state.messages ? "active" : ""}>
                                            <i className="fas fa-pencil-ruler"></i> Messages <span className="badge badge-danger">6</span>
                                        </li>
