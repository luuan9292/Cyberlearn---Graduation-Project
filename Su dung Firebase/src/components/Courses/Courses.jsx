                    ...
                    <div className="row sort__filter align-items-center">
                        ...
                        <div className="col-sm-6 col-md-6 col-lg-6 col-xl-6 text-right pr-0">
                            <div className="filter">
                                <span className="pr-4 showing">Showing 1–{this.props.children.props.children && this.props.children.props.children.length} of {this.props.children.props.children && this.props.children.props.children.length} results</span>
